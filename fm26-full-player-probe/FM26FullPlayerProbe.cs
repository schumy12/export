...
{
    [BepInPlugin("com.schumy12.fm26.fullplayerprobe", "FM26 Full Player Probe", "0.12.2")]
    public sealed class Plugin : BasePlugin
    {
        ...
        {
            Log = base.Log;
            Log.LogInfo("[FM26FullProbe] Loaded v0.12.2 TARGETED - open player profile, press F8. No Harmony, no UI traversal.");
    ...
    public sealed class ProbeBehaviour : MonoBehaviour
    {
        ...
        private void ProbeRuntime()
        {
            ...
            Line(sb, "=== FM26 FULL PLAYER PROBE 0.12.2 TARGETED RUNTIME ===");
        ...
        private static void ProbeBindingSubsystem(StringBuilder sb)
        {
            try
            {
                ...
                Line(sb, "BindingSubsystem present=true");
            }
            catch (Exception ex)
            {
